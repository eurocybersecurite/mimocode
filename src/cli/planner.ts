...
export async function generatePlan(config: Config, task: string): Promise<PlanStep[]> {
  const messages: Message[] = [
    ...
    Guidelines:
    1. Research First: If the task involves a specific technology, library, or external service (like Gemini API, GitHub, etc.), the FIRST step should ALWAYS be to research its documentation or best practices using the 'web_search' or 'researcher' agent.
