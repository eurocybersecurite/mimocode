...
[![npm version](https://badge.fury.io/js/mimocode.svg)](https://www.npmjs.com/package/mimocode)
[![npm downloads](https://img.shields.io/npm/dt/mimocode.svg)](https://www.npmjs.com/package/mimocode)
[![npm license](https://img.shields.io/npm/l/mimocode.svg)](https://www.npmjs.com/package/mimocode)
...
- **CLI Terminal Interactif** : Une expérience fluide avec autocomplétion, historique persistant, rendu Markdown riche et commandes slash.
...
### 1. Prérequis
- **Node.js** (v18+)
- **Ollama** (recommandé) ou tout autre runtime LLM local.
- **ripgrep** (optionnel, pour des recherches ultra-rapides via `mimocode search`).

### 2. Installation depuis npm
...
npm update -g mimocode

# Ou réinstaller proprement
npm uninstall -g mimocode
npm install -g mimocode
mimocode --version
🔍 Dépannage (Troubleshooting)

Erreur command not found: mimocode :
Assurez-vous que Node.js est installé et que npm est dans votre PATH.
...
Lors d'une modification de fichier par l'IA, Mimocode affiche un diff coloré vous permettant de valider précisément les changements avant qu'ils ne soient appliqués.
...
GitHub : @eurocybersecurite
📄 License

MIT © Abdessemed Mohamed

⭐ Si vous aimez Mimocode, n'hésitez pas à mettre une étoile sur GitHub !